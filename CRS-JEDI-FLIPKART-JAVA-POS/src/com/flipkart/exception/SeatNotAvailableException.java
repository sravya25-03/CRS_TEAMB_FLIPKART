...
/**
 * SeatNotAvailableException is a custom exception class that extends the Exception class.
...
public class SeatNotAvailableException extends Exception {
    ...
    /**
     * Constructs a new SeatNotAvailableException with the specified course code.
