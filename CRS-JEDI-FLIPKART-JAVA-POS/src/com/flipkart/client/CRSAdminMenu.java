/**
 * CRSAdminMenu: This class represents the administrative menu for the Course Registration System (CRS).
 * It provides various functionalities such as adding/deleting courses, approving students, adding professors,
 * assigning courses to professors, and generating report cards.
 */
...
public class CRSAdminMenu {
    ...
    // Instances of business logic interfaces and scanner
    ...
    private void generateReportCard() {
        ...
        try {
            // Set report card generated flag
            adminOperation.setGeneratedReportCardTrue(studentId);
            if (isReportGenerated) {
                // View grade card for the student
