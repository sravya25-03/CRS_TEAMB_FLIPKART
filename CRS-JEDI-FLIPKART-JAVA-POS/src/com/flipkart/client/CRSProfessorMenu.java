/**
 * This class represents the menu for the professor interface in the Course Registration System (CRS).
 * It allows professors to view courses they are teaching, view enrolled students, and add grades for students.
 */
...
public class CRSProfessorMenu {
    ...
    /**
     * Method to create the professor menu
     * 
    ...
    /**
     * Method to view enrolled students in courses taught by the professor
     * 
     * @param profID Professor ID
     */
    ...
    /**
     * Method to view courses taught by the professor
     * 
     * @param profId Professor ID
     */
